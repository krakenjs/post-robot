...
$ git remote add upstream git://github.com/krakenjs/post-robot.git
...
`gulp lint`.
3. Ensure existing tests pass (`gulp test`) and include test cases which fail without your change and succeed with it.

## Submitting Changes
1. Ensure that no errors are generated by ESLint, CSSLint or any other tools that you use for debugging your code.
